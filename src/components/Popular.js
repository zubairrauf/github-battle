        ...
        <ul className='flex-center'>
            {languages.map((language, index) => (
                ...
                <button 
                    ...
                    style={language === selected ? {color: 'rgb(187,46,31)', backgroundColor: 'lightYellow'} : null}
...
export default class Popular extends React.Component {
    ...
    componentDidMount(selectedLang) {
    ...
    render() {
       ...
       return (
           <React.Fragment>
            <LanguagesNav selected={selectedLang} onUpdateLanguage={this.updateLang} />
